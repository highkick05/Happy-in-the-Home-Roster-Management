...
# Replace Evidence Matrix rendering block exactly
# I need to find the start of the evidenceMatrix.map block.

start_str = """                       evidenceMatrix.map((row, idx) => {"""
end_str = """                       })
                     )}
                   </tbody>
                 </table>"""
...
new_block = """                       evidenceMatrix.map((row, idx) => {
...
print("Updated UI rendering block")
