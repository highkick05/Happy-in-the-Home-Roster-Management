...
// Also compact the top level columns from md:grid-cols-2 to just flex-col so it's vertically stacked and compact
content = content.replace(`<div className="flex flex-col md:grid md:grid-cols-2 gap-4">`, `<div className="flex flex-col gap-4">`);
