...
const oldHeaderBlock = `<div className="flex flex-wrap items-center gap-3 w-full md:w-auto justify-end">
          {user?.role === 'ADMIN' && (
            <>
              <select
                value={groupBy}
...
const newHeaderBlock = `<div className="flex flex-wrap items-center gap-3 w-full xl:w-auto justify-end">
          {user?.role === 'ADMIN' && (
...
console.log("Updated header block.");
