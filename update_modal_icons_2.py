...
target = """        <div className="w-full h-24 bg-[#273548] flex items-center justify-center border-b border-border-subtle overflow-hidden">
           {(() => {
...
if target in code:
    ...
    print("Replaced top banner with getFileIconUrl")
else:
    print("Target not found for top banner")
