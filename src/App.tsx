...
import ClientBudgetView from './components/Directory/ClientBudgetView';
      ...
      <AuthProvider>
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/clients/:id/budget" element={<ProtectedRoute adminOnly><Layout><ClientBudgetView /></Layout></ProtectedRoute>} />
