...
export default function FloatingChatIcon() {
  ...
  return (
    <div className="fixed bottom-6 right-4 z-[9999] lg:hidden">
      {isOpen && (
        <div ref={popupRef} className="absolute bottom-16 right-0 w-[90vw] max-w-[400px] h-[65vh] max-h-[600px] bg-brand-bg border border-border-subtle rounded-xl shadow-2xl flex flex-col overflow-hidden animate-in fade-in slide-in-from-bottom-4">
