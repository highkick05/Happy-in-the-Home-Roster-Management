         ...
         <div className="flex border-b-[1.5px] border-black">
            ...
            <div className="w-[45%] flex flex-col justify-between shrink-0">
               ...
               <div className="flex items-end px-3 py-1.5 border-b-[1.5px] border-black">
                 ...
                 <span className="flex-1 text-xs font-mono pl-1 border-b border-black/30 w-full mb-0.5 leading-tight break-words">
               ...
               <div className="flex items-end px-3 py-1.5 border-b-[1.5px] border-black">
                 ...
                 <span className="flex-1 text-xs font-serif pl-1 border-b border-black/30 w-full mb-0.5 leading-tight break-words">{clientData?.address || ''}</span>
               </div>
               <div className="flex items-end px-3 py-1.5">
                 <span className="shrink-0 w-[95px] text-xs font-bold uppercase whitespace-nowrap">ID No.</span>
                 <span className="flex-1 text-xs font-mono pl-1 border-b border-black/30 w-full mb-0.5 leading-tight break-words">{safeRefNumber}</span>
               </div>
            </div>
         </div>
                  ...
                  notes.map((note, index) => {
                     ...
                     return (
                       <div key={note.id} className={`flex ${index !== notes.length - 1 ? 'border-b-[1.5px] border-black' : ''} break-inside-avoid-page`}>
                          ...
                          {/* Date & Time Column */}
                          <div className="w-[120px] p-2 text-xs border-r-[1.5px] border-black shrink-0 font-medium">
                             <div>{dateStr}</div>
