...
const targetJSX = `<div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 bg-zinc-800/50 p-3 rounded-lg border border-white/[0.05] gap-3">
