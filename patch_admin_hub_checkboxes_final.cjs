...
const targetStr = `                            <label className="flex items-center space-x-3 cursor-pointer group">
...
content = content.replace(targetStr, checkboxesStr.trim());

fs.writeFileSync(file, content, 'utf8');
console.log('patched checkboxes properly');
